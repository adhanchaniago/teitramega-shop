...
?>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="contact-us">
            ...
            <ul class="contact-list">
              ...
              <li><i class="icon-envelope"></i> <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d2a1b3beb7a192b7bfb3a0a6fcb1bdbf">[email&#160;protected]</a> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f88b8d8888978a8cb89d95998a8cd69b9795">[email&#160;protected]</a></span></li>
            </ul>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <p>All copyrights reserved &copy; 2018 -  Developed by <a rel="nofollow" href="https://www.facebook.com/muhamadzakky45">Muhamad Zakky</a></p>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12">
  ...
  <script data-cfasync="false" src="<?php echo base_url('/') ?>assets/js/email-decode.min.js"></script><script type="text/javascript" src="assets/js/jquery-min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('/') ?>assets/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('/') ?>assets/js/bootstrap-select.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('/') ?>assets/js/owl.carousel.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('/') ?>assets/js/ion.rangeSlider.js"></script>
